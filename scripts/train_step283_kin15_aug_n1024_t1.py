"""Step 283: K_in=15 + aug compound @ N=1024 T1.

MOTIVATION
==========
K_in=15+aug compound confirmed at N=2048 T2 (+0.18pp), N=4096 T2 running (step279),
N=8192 T2 running (step282). N=1024 is the missing bottom of the compound scaling curve.

Aug alone at N=1024 T2 = +0.54pp (step280). K_in=15 costs ~−0.33pp (consistent across
N=2048/4096/8192). Compound hypothesis: net ~+0.21pp at N=1024.

CONFIGS
=======
  Ref_n1024       : N=1024, K_in=25, no-aug
  C_k15_aug_n1024 : N=1024, K_in=15, aug (COMPOUND — bottom of scaling curve)
...
OUT_PATH = ROOT / "results" / f"train_step283_kin15_aug_n1024_t1_seed{SEED}__{SLOT}.json"

CONFIGS = {
    "Ref_n1024":       (25, False, "N=1024 K_in=25 no-aug ref"),
    "C_k15_aug_n1024": (15, True,  "N=1024 K_in=15 + aug (COMPOUND bottom of curve)"),
}
...
def main():
    ...
    print(f"Step 283 — K_in=15+aug compound @ N=1024 (T1: {EPOCHS}ep, 50% data)")
    ...
    print(f"\n{'='*60}")
    print(f"STEP 283 SUMMARY — K_in=15+aug compound @ N=1024 (T1)")
