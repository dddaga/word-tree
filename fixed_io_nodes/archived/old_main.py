"""
1) This uses threading, the newer version uses multiprocessing.
2) The newer version takes parameters from config file instead of being hardcoded.
3) The newer version also uses a logger process to log the training progress (loss or anything else)

All these things required a lot of changes so I decided to just write a new version. 
"""
