...
fig.tight_layout()
fig.savefig(os.path.join(SCRIPT_DIR, "accuracy_vs_hidden_size_per_sparsity.png"), dpi=200, bbox_inches="tight")
...
fig2.tight_layout()
fig2.savefig(os.path.join(SCRIPT_DIR, "loss_vs_hidden_size_per_sparsity.png"), dpi=200, bbox_inches="tight")
...
fig3.tight_layout()
fig3.savefig(os.path.join(SCRIPT_DIR, "accuracy_variance_vs_hidden_size.png"), dpi=200)
...
fig4.tight_layout()
fig4.savefig(os.path.join(SCRIPT_DIR, "loss_variance_vs_hidden_size.png"), dpi=200)
