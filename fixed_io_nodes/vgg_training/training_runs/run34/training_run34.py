"""
run34 — Uniform routing at C=200, I=2: extreme iteration reduction.

run33 (I=3): 87.16% @ 0.48B — beat run17 at half FLOPs.
run34 (I=2): ???  @ 0.24B — 4x FLOPs savings vs run29.

At I=2, only ONE propagation step after input injection. If val >75%,
this is a huge per-FLOP win (prior best @ 0.24B was run31 at 79.54%).
...
def main(config_path: str = None):
    ...
    print("Training started (run34 -- UNIFORM ROUTING, N=4146, C=200, I=2, no FFN)")
    print("  Routing: 1/degree (uniform) instead of softmax")
    print("  I=2 — extreme iteration reduction; 4x FLOPs savings vs run29")
