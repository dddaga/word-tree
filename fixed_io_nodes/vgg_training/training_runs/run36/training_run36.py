"""
run36 — Uniform routing + D=16: test higher vector_dim as accuracy lever.

Current ceiling: 89.15% (run29, D=8, I=5). Can doubling feature dim help?
Config: N=2048, D=16, I=3, C=200. FLOPs ~0.45B (similar to run33's 0.48B).

Team member achieves 95.52% with D=16 but different routing. Our routing
works better at C=200 (uniform); D=16 adds expressive capacity per node.
...
def main(config_path: str = None):
    ...
    print("Training started (run36 -- UNIFORM ROUTING + D=16, N=2048, C=200, I=3)")
    print("  Routing: 1/degree (uniform) + vector_dim=16")
    print("  Tests if D=16 pushes past 89.15% ceiling")
