"""
run41 — D=16 + C=10 + I=5: aggressive sparsity test toward 1M FLOPs target.

run40 (D=16, C=50, I=5): 83.06% @ 0.23B. Can C=10 still learn with I=5?
FLOPs: ~57M = 0.057B (4x cheaper than run40, 16x cheaper than run36).
...
def main(config_path: str = None):
    ...
    print("Training started (run41 -- UNIFORM ROUTING + D=16 + C=10 + I=5)")
    print("  Aggressive sparsity test: ~0.057B FLOPs toward 1M target")
    print("  16x cheaper than run36; if >70% → strong Pareto point")
