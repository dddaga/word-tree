"""
run40 — D=16 + C=50 + I=5: test if more iterations rescue low cardinality.

run39 (D=16, C=50, I=3): 75.49% — below run31 (D=8, C=50, I=5: 79.54%).
Hypothesis: low C needs high I for propagation. run40 tests D=16 + C=50 + I=5.
...
def main(config_path: str = None):
    ...
    print("Training started (run40 -- UNIFORM ROUTING + D=16 + C=50 + I=5)")
    print("  Testing iteration rescue: D=16 + C=50 + I=5 = 0.23B FLOPs")
    print("  vs run39 (I=3): +2 iterations to test low-C/high-I coupling")
