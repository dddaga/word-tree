"""
run39 — D=16 + C=50: further aggressive FLOPs reduction.

run38 (D=16, C=100): 85.91% @ 0.23B. Can C=50 still work at D=16?
run39 (D=16, C=50):  ??? @ 0.12B — 4x cheaper than run36 (D=16, C=200).
...
def main(config_path: str = None):
    ...
    print("Training started (run39 -- UNIFORM ROUTING + D=16 + C=50, N=2048, I=3)")
    print("  Testing FLOPs floor at D=16: C=50 (4x cheaper than run36's C=200)")
    print("  Expected ~0.12B FLOPs; prior best at this budget: 79.54% (D=8, C=50)")
