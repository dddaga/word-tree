"""
run37 — D=16 + I=5: push accuracy past 89.55% ceiling.

run36 (D=16, I=3) hit 89.55% — NEW BEST. Can more iterations push past 90%?
Config: N=2048, D=16, I=5, C=200. FLOPs ~0.9B (similar to run29 but D=16).
...
def main(config_path: str = None):
    ...
    print("Training started (run37 -- UNIFORM ROUTING + D=16 + I=5, N=2048)")
    print("  Pushing ceiling: D=16, I=5, C=200")
    print("  run36 (I=3) got 89.55%. Can I=5 break 90%?")
