"""
run42 — D=16 + C=25 + I=5: pinpoint the cardinality cliff.

run40 (C=50) → 83.06%. run41 (C=10) → 27.97%. Cliff is between them.
run42 (C=25) pinpoints where the viability boundary lies.
...
def main(config_path: str = None):
    ...
    print("Training started (run42 -- UNIFORM ROUTING + D=16 + C=25 + I=5)")
    print("  Pinpointing cardinality cliff: C=50 → 83%, C=10 → 28%")
    print("  C=25 at 0.12B FLOPs; if >70% → viable Pareto point")
