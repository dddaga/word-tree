"""
run38 — D=16 + C=100: aggressive FLOPs reduction on best-in-class config.

run36 (D=16, C=200): 89.55% @ 0.45B — Pareto-best at 0.45B.
run38 (D=16, C=100): ???   @ 0.23B — half the FLOPs.
If val >87% → new Pareto point at 0.23B (vs prior run31's 79.54%).
...
def main(config_path: str = None):
    ...
    print("Training started (run38 -- UNIFORM ROUTING + D=16 + C=100, N=2048, I=3)")
    print("  Testing FLOPs reduction at D=16: C=100 (half of run36's C=200)")
    print("  Expected ~0.23B FLOPs (half of run36's 0.45B)")
