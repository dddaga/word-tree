"""
run35 — Uniform routing at C=200, I=4: fill iteration curve mid-point.

Iteration sweep so far:
  I=2 (run34): 72.05% @ 0.24B
  I=3 (run33): 87.16% @ 0.48B
  I=5 (run29): 89.15% @ 0.96B
run35 (I=4) @ 0.72B — checks if the curve is smooth between I=3 and I=5.
...
def main(config_path: str = None):
    ...
    print("Training started (run35 -- UNIFORM ROUTING, N=4146, C=200, I=4, no FFN)")
    print("  Routing: 1/degree (uniform) instead of softmax")
    print("  I=4 — mid-point; fills curve between I=3 (87.16%) and I=5 (89.15%)")
